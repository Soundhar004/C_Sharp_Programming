...
{
    public class Electricity_Board
    {
        DB_Handling dbHandler = new DB_Handling();

        public void AddBill(Electricity_Bill ebill)
        {
        ...
        public void CalculateBill(Electricity_Bill ebill)
        {
        ...
        public List<Electricity_Bill> Generate_N_BillDetails(int num)
        {
            var bills = new List<Electricity_Bill>();
            using (SqlConnection con = dbHandler.GetConnection())
            {
                ...
                using (SqlDataReader reader = cmd.ExecuteReader())
                {
                    while (reader.Read())
                    {
                        Electricity_Bill ebill = new Electricity_Bill();
